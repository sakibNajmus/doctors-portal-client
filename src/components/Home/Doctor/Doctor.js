...
import img from '../../../resources/images/doctor-sm.png'
...
const Doctor = ({doctor}) => {
    return (
        <div className="col-md-4 col-sm-6 text-center">
        {
            ...
            :
            <img style={{height: '200px'}} className="img-fluid mb-3" src={`https://young-oasis-31596.herokuapp.com/${doctor.img}`} alt=""/>
        }
            <h4>{doctor.name}</h4>
